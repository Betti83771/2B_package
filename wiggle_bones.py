...
def jiggle_pre(self):
    ...
    if not bpy.context.scene.jiggle_enable: return
    global curframe
...
def jiggle_post(self, depsgraph):
   ...
   # global skip_handler
    ...
    if bpy.context.window_manager.jiggle_skip_handler:
      #  print("returning jiggle post")
        return
    bpy.context.window_manager.jiggle_skip_handler = True
    ...
    bpy.context.window_manager.jiggle_skip_handler = False     
...
def register():
    ...
    bpy.types.WindowManager.jiggle_skip_handler = bpy.props.BoolProperty(
        name = 'Skip Handler',
        default = False
    )
...
def unregister():
    del bpy.types.WindowManager.jiggle_skip_handler
